const cart = JSON.parse(sessionStorage.getItem("cart")) || [];
  ...
  cart.forEach((product, index) => {
        ...
        <div id="combined-info">
          ...
          <div id="quantity">
            <select name="quantity" class="select-quantity">
              ...
              <option value="4" ${product.quantity == 4 ? "selected" : ""}>Quantity:4</option>
              <option value="5" ${product.quantity == 5 ? "selected" : ""}>Quantity:5</option>
            </select>
          </div>
    ...
    productInfo.querySelector(".remove-from-cart").addEventListener("click", () => {
